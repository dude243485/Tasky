...
import { Home, ClipboardCheck, Settings, X } from "lucide-react";
            ...
            <div className = {`fixed z-150 w-3/4 overflow-hidden rounded-r-4xl bg-slate-50  dark:bg-slate-900 
                text-slate-900 dark:text-slate-50 px-6 min-h-screen`}>
                    ...
                    >
                        ...
                        className = { `px-3 py-3 flex gap-2 items-center rounded-[10px] cursor-pointer ${isSettings ? "bg-slate-200 text-slate-700" : ""}`}>
