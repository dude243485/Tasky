...
const PopupModal: React.FC<PopupModalProps> = ({
    ...
    return createPortal(
        <div className="fixed inset-0 z-120 flex flex-col justify-end ">
            ...
            />
            <div className="p-8 z-120 w-full max-w-lg overflow-hidden rounded-t-4xl bg-slate-50 transition-all dark:bg-slate-900 text-slate-900 dark:text-slate-50 flex flex-col items-center">
